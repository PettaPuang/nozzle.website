            ...
            >
              ...
              <div className="flex items-center gap-1.5 px-1.5 py-1 bg-gray-50 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700">
                ...
                <Image
                  ...
                  className="h-3 w-3"
                />
                <h2 className="text-[10px] font-semibold text-gray-700 dark:text-gray-300">
                  {owner.name}
                </h2>
                ...
                {mockSpbus
                  ...
                  .map((spbu, index) => (
                    <motion.div
                      ...
                      className="border-b border-gray-200 dark:border-gray-700 px-1.5 py-1.5"
                    >
                      <div className="flex items-start gap-1.5">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="text-[10px] font-semibold text-gray-900 dark:text-white truncate">
                            {spbu.name}
                          </h3>
                          <div className="flex items-start gap-0.5 text-[9px] text-gray-600 dark:text-gray-400 mt-0.5">
